$(document).ready(function() {
  ...
  // OnClick event to handle store search value
  $("#search-button").on("click", function() {
    ...
    // Pass entered city value into searchWeather
    searchWeather(searchValue);
  });

    // Listen for button click
  $(".history").on("click", "li", function() {
    // Pass in text of button
    searchWeather($(this).text());
  });

  // function for appending search terms as list items
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (history.indexOf(searchValue) === -1) {
          ...
          // Call makeRow function to append it
          makeRow(searchValue);
        }
